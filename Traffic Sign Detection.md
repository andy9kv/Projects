...
!<align="left" img width="33%" height="100%" src="Project_Files/Traffic_Sign_Detection/media/demo.gif"> !<align="center" img width="33%" height="100%" src="Project_Files/Traffic_Sign_Detection/media/demo.gif"> !<align="right" img width="33%" height="100%" src="Project_Files/Traffic_Sign_Detection/media/demo.gif">
