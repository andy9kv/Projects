...
/*Default Constructor. Initializes a default Poly, an empty
name, and identity matrices for transformations*/
public Node(){ this(new Poly(), "");}

/*virtually the default constructor, expect initializes
name to the specified name*/
public Node(String name){ this(new Poly(), name);}

/*initializes the Poly to the specified Poly, name to the
specified name, and identity matrices for transformations*/
public Node(Poly shape, String name){
...
public Node(Node original){
	this(original.getPoly(), original.getName());
	this.children = original.getChildren();
	this.uniqueID = original.getID();
...
public Node transform(Node parent){
	...
	return new Node(transformed, this.name);
}
