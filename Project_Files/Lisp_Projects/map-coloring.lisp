...
;; goes through the color solution, prints each vertex and its
;; color along with its edges and their colors to verify that 
;; there are no conflicts in the solution 
;; Author: Calvin Alvarez
